...
Также это приглашение поработать вместе. Ниже записаны несколько идей улучшения приложения. Можно склонировать этот репозиторий, добавить свои изменения, а затем отправить результат [письмом](mailto:o.solovyov@modnakasta.ua), или в виде приглашения в закрытый репозиторий (например, Bitbucket, или любой другой).
...
[Пишите!](mailto:o.solovyov@modnakasta.ua)
